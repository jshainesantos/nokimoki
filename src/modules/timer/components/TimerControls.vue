...
.btn-main {
  ...
  align-items: center;
  justify-content: center;
  box-shadow: var(--shadow-clay), var(--shadow-md);
...
.btn-main:hover {
  ...
  box-shadow: 5px 7px 0px rgba(var(--text-rgb), 0.18), var(--shadow-md);
}

.btn-main:active {
  transform: translateY(2px) scale(0.97);
  box-shadow: 2px 2px 0px rgba(var(--text-rgb), 0.18);
}
...
.btn-reset {
  ...
  box-shadow: 3px 3px 0px rgba(var(--text-rgb),0.12);
...
.btn-reset:active {
  ...
  box-shadow: 1px 1px 0px rgba(var(--text-rgb),0.1);
}
